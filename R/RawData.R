...
#' - **Dietary_energy_density**: Energy density (kJ/g) of the female diet calculated from the average energy content per gram of prey body tissue.
#' - **Diet.diversity**: Standardized Shannon-Weaver diversity index to quantify individual diet diversity.
#' - **Dominant_prey_species**: The prey species making up the greatest proportion of the mothers diet.
...
#'
#' @source Data from the Department of Fisheries and Oceans Canada grey usethis::use_data(raw_data, overwirte=TRUE)seal program
#'
#' @examples
#' data(raw_data)
#' summary(raw_data)
